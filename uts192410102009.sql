...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Bulan Mei 2021 pada 18.32
...
--
-- Struktur dari tabel `countrylanguage`
--
...
--
-- Dumping data untuk tabel `countrylanguage`
--
...
--
-- Indeks untuk tabel `countrylanguage`
--
...
--
-- Ketidakleluasaan untuk tabel `countrylanguage`
--
ALTER TABLE `countrylanguage`
